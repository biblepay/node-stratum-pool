...
var pool = module.exports = function pool(options, authorizeFn) {
            ...
            DetectCoinData(function () {
                ...
                OnBlockchainSynced(function () {
                    GetFirstJob(function () {
                        SetupBlockPolling();
                        SetupPeer();
                        StartStratumServer(options.monero, portalConfig.website.stratumHost, function () {
                            OutputPoolInfo();
                            _this.emit('started');
                        });
                    });
    ...
    */
    ...
    function StartStratumServer(monero1, stratumHost, finishedCallback) {

        _this.stratumServer = new stratum.Server(options, authorizeFn, monero1, stratumHost);
